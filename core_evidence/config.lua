...
ChancePercentageShots = 80, -- Percentage Chance for the shots to not have enough evidence for name
ChancePercentageBlood = 40, -- Percentage Chance for the blood to not have enough evidence for name
...
AllowedGrades = {10, 14, 18, 22, 23, 24, 25}, -- CID/Cabinet ranks

CloseReportKey = 'BACKSPACE', -- The key used to close the report
PickupEvidenceKey = 'E', -- The key used to pick up evidence

EvidenceAlanysisLocation = vector3(483.64, -987.89, 30.69), -- The place where the evidence will be analyzed and report generated
...
TimeBeforeCrimsCanDestory = 150, -- Seconds before Criminals can destroy evidence (300 is the time when evidence coolsdown and shows up as WARM)
EvidenceStorageLocation = vector3(483.91, -993.25, 30.96), -- The place where all evidence are being archived! You can view old evidence or delete it
--
