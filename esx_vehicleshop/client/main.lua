	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'shop_confirm', {
			...
			if data2.current.value == 'yes' then
				if Config.EnablePlayerManagement then
					ESX.TriggerServerCallback('3e0d0590-fab2-4c0f-92ee-dc842785023e', function(hasEnoughMoney)
					...
					if Config.EnableSocietyOwnedVehicles and playerData.job.grade_name == 'boss' then
						ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'shop_confirm_buy_type', {
							...
							if data3.current.value == 'personnal' then
								...
								ESX.TriggerServerCallback('25bccb4c-cb37-4cf4-b9f2-8575d40332a', function(hasEnoughMoney)
									if hasEnoughMoney then
										IsInShopMenu = false
										...
										ESX.Game.SpawnVehicleaa7b(vehicleData.model, Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
											...
											if Config.EnableOwnedVehicles then
												if vehicleData.model == "thauler" or vehicleData.model == "enclosed" or vehicleData.model == "JetskiT" then	
													TriggerServerEvent('dhyrjk-837hyr-oei84i-loe94', vehicleProps, 'trailer')
												else
													TriggerServerEvent('dhyrjk-837hyr-oei84i-loe94', vehicleProps)
												end
											end
							...
							if hasEnoughMoney then
								...
								ESX.Game.SpawnVehicleaa7b(vehicleData.model, Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
									...
									if Config.EnableOwnedVehicles then
										if vehicleData.model == "thauler" or vehicleData.model == "enclosed" or vehicleData.model == "JetskiT" then	
											TriggerServerEvent('dhyrjk-837hyr-oei84i-loe94', vehicleProps, 'trailer')
											TriggerServerEvent('dhyrjk-837hyr-oei84i-loe945')
										else
											TriggerServerEvent('dhyrjk-837hyr-oei84i-loe94', vehicleProps)
											TriggerServerEvent('dhyrjk-837hyr-oei84i-loe945')
										end
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reseller', {
		...
		elseif action == 'set_vehicle_owner_sell' then
			...
			if closestPlayer == -1 or closestDistance > 3.0 then
				...
				TriggerServerEvent('28ecc9e3-09e7-41db-aa83', model)
				...
				if Config.EnableOwnedVehicles then
					if CurrentVehicleData.model == "thauler" or CurrentVehicleData.model == "enclosed" or CurrentVehicleData.model == "JetskiT" then	
						TriggerServerEvent('1c72c501-8949-41f3-84a7-9e22c51e4a3', GetPlayerServerId(closestPlayer), vehicleProps, 'trailer')
					else	
						TriggerServerEvent('1c72c501-8949-41f3-84a7-9e22c51e4a3', GetPlayerServerId(closestPlayer), vehicleProps)
					end
					--TriggerServerEvent('1c72c501-8949-41f3-84a7-9e22c51e4a3', GetPlayerServerId(closestPlayer), vehicleProps)
