...
Citizen.CreateThread(function()
	...
	AddNewVariation("Hair", "Female", 4, 42, true)
	AddNewVariation("Hair", "Female", 24, 42, true)
	AddNewVariation("Hair", "Female", 35, 42, true)
	AddNewVariation("Hair", "Female", 36, 42, true)
	AddNewVariation("Hair", "Female", 37, 42, true)
	AddNewVariation("Hair", "Female", 46, 42, true)
	AddNewVariation("Hair", "Female", 44, 42, true)
	AddNewVariation("Hair", "Female", 70, 42, true)
	AddNewVariation("Hair", "Female", 61, 42, true)
	AddNewVariation("Hair", "Female", 64, 42, true)
	AddNewVariation("Hair", "Female", 67, 42, true)
	...
	AddNewVariation("Jackets", "Male", 261, 330)
