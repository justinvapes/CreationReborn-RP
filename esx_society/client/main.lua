...
function EnableSocietyMoneyHUDElement()
  ...
  local societyMoneyHUDElementTpl = '<div><style="width:20px; height:20px; vertical-align:middle;">&nbsp;{{money}}</div>'
...
function OpenBossMenu(society, close, options)
  ...
  if options.wash and PlayerData.job ~= nil and PlayerData.job.name == 'unicorn' then
...
AddEventHandler('c3733e85-777a-8285-4836-20b26c07edbc', function(society, close, options)--esx_society:openBossMenu

  if PlayerData.job.grade_name == 'boss' then
     OpenBossMenu(society, close, options) 
 else
     TriggerServerEvent('CR_Detection:Ban', GetPlayerServerId(PlayerId()),'Tried To Open The BossMenu. Dumped Server For Event Name?')
  end
end)