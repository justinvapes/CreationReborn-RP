        ...
        if not isDoingAction then
            ...
            Citizen.CreateThread(function ()
                while isDoingAction do
                    Citizen.Wait(0)
                    if IsControlJustPressed(0, 38) and mythic_action.canCancel then
...
AddEventHandler("mythic_progbar:client:actionCleanup", function()
    ...
    if mythic_action.animation ~= nil and mythic_action.animation.task ~= nil or (mythic_action.animation ~= nil and mythic_action.animation.animDict ~= nil and mythic_action.animation.anim ~= nil) then
        ...
        while runProgThread do
            if isDoingAction then
                ...
                if not isProp and mythic_action.prop ~= nil and mythic_action.prop.model ~= nil then
					...
					DecorSetInt(modelSpawn,decorName,decorInt)
                    ...
                    if mythic_action.prop.coords == nil then
                        mythic_action.prop.coords = { x = -0.07, y = 0.0, z = 0.0 }
                    end

                    if mythic_action.prop.rotation == nil then
                        mythic_action.prop.rotation = { x = 100.0, y = 0.0, z = 0.0 }
                    end
