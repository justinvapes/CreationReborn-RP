! function(e) {
    ...
    function k(e, t, i, r, o, n) {
        if (t.valueBox) {
            ...
            t.colorValueBoxShadow && (e.shadowBlur = 1.2 * s, e.shadowColor = t.colorValueBoxShadow), t.colorValueBoxBackground && (e.fillStyle = t.colorValueBoxBackground, e.fill()), e.closePath(), e.restore(), y(e, t, d, u), e.fillStyle = t.colorValueText, e.textAlign = "center", e.textBaseline = "alphabetic", e.fillText(a, S + g / 2, o + k / 2 - m / 3), e.restore()
        }
    }
    ...
    function V(e, t) {
        ...
        for (e.lineWidth = be.pixelRatio, e.strokeStyle = t.colorMinorTicks, e.save(), t.exactTicks ? (o = t.maxValue - t.minValue, r = o / t.minorTicks, l = t.majorTicks[0] % t.minorTicks * s) : r = t.minorTicks * (t.majorTicks.length - 1); a < r; ++a) n = t.startAngle + l + a * (t.ticksAngle / r), e.rotate(Te.radians(n)), e.beginPath(), e.moveTo(0, i), e.lineTo(0, i - .075 * e.max), A(e)
    }
    ...
    function B(e, t) {
        ...
        var i = ye(P(e, t)),
            ...
            a = be.pixelRatio;
        for (e.lineWidth = 2 * a, e.save(), o = t.colorMajorTicks instanceof Array ? t.colorMajorTicks : new Array(n).fill(t.colorMajorTicks), r = 0; r < n; ++r) e.strokeStyle = o[r], e.rotate(Te.radians(M(t, t.exactTicks ? t.majorTicks[r] : r, n))), e.beginPath(), e.moveTo(0, i), e.lineTo(0, i - .05 * e.max), A(e);
    ...
    function J(e, t, i, r, o, n, a, l, s) {
        ...
        try {
            for (var j, C = i[Symbol.iterator](); !(B = (j = C.next()).done); B = !0) {
                var N = j.value;
                e.strokeStyle = V[i.indexOf(N)], c ? (T = p + h - m - f + (r - N) * P, n && (x = g + W, H(e, x, T, we(x - S), T)), a && (x = g + O, H(e, x, T, we(x - S), T))) : (x = g + m + f - (r - N) * P, n && (T = p + W, H(e, x, T, x, we(T - S))), a && (T = p + O, H(e, x, we(T), x, T - S)))
            }
        } catch (e) {
            M = !0, A = e
        } finally {
    ...
    function $(e, t) {
        ...
        if (J(e, s, t.exactTicks ? t.majorTicks : t.majorTicks.map(function(e, i) {
            ...
            var d = e.barDimensions,
                ...
                W = void 0,
                O = void 0;
            e.strokeStyle = s[0], a *= w, c ? (S = g + h - m - v + a / 2, O = S - p - a, o && (W = T = we(b + x), Z(e, T, S, W, O)), n && (W = T = we(b + k), Z(e, T, S, W, O))) : (T = b + m + v - a / 2, W = T + p + a, o && (O = S = we(g + x), Z(e, T, S, W, O)), n && (O = S = we(g + k), Z(e, T, S, W, O)))
        }
    }
    ...
    function K(e, t) {
        ...
        if (t.exactTicks)
            for (var d = t.majorTicks[0] % t.minorTicks; l < t.maxValue; l += t.minorTicks) a.push(d + l);
        else
            for (; l < t.maxValue; l += s) a.push(l);
                    ...
                    try {
                        ...
                        if ("needle" === l.animationTarget) {
                            if (!e.elementClone.initialized) {
                                ...
                                s.clearRect(r, o, n, a), s.save(), this.emit("beforePlate"), W(s, l), this.emit("beforeHighlights"), O(s, l), this.emit("beforeMinorTicks"), V(s, l), this.emit("beforeMajorTicks"), B(s, l), this.emit("beforeNumbers"), j(s, l), this.emit("beforeTitle"), C(s, l), this.emit("beforeUnits"), N(s, l), e.elementClone.initialized = !0
                            }
    ...
    void 0 !== e && (e.LinearGauge = Be), xe.initialize("LinearGauge", Pe), "undefined" != typeof module && Object.assign(e, {
        Collection: l,
        GenericOptions: ge,
        Animation: me,
        BaseGauge: xe,
