...
Config.Houses = {
    ...
    },
    {
        ...
        Price = 10000000,
        Garage = {
            Exit = vector4(-129.69, 1004.55, 235.23, 198.05), -- where the car will spawn when you take it out from your garage
            Entrance = vector3(-123.11, 1006.64, 235.73), -- where you enter the garage
        },
        Entrance = vector4(-112.99, 985.97, 235.75, 108.34),
        Type = "house", -- apartment or house
        ShellType = "pandamants",
    },
    {
        Label = "South Milton Dr",
        Price = 10000000,
        Garage = {
            Exit = vector4(-827.65, 270.43, 86.2, 349.92), -- where the car will spawn when you take it out from your garage
            Entrance = vector3(-827.65, 270.43, 87.2), -- where you enter the garage
        },
        Entrance = vector4(-819.49, 267.83, 86.4, 78.47),
        Type = "house", -- apartment or house
        ShellType = "marsbar1893",
    },
    {
        Label = "Lake Vinewood Estates 2",
        Price = 10000000,
        Garage = {
            Exit = vector4(-105.97, 823.96, 235.22, 17.12), -- where the car will spawn when you take it out from your garage
            Entrance = vector3(-102.93, 823.41, 235.73), -- where you enter the garage
        },
        Entrance = vector4(-85.88, 834.57, 235.92, 92.96),
        Type = "house", -- apartment or house
        ShellType = "xelementzx",
    },
    {
        Label = "Franklin",
        Price = 600000,
        Garage = {
            Exit = vector4(22.67, 544.13, 175.53, 61.28), -- where the car will spawn when you take it out from your garage
            Entrance = vector3(22.67, 544.13, 176.03), -- where you enter the garage
        },
        Entrance = vector4(8.32, 539.6, 176.03, 331.12),
        Type = "house", -- apartment or house
        ShellType = "delta",
    },
    {
        Label = "Sam Austin Drive",
        Price = 10000000,
        Garage = {
            Exit = vector4(-1576.91, -81.02, 54.13, 267.14), -- where the car will spawn when you take it out from your garage
            Entrance = vector3(-1577.29, -86.25, 54.13), -- where you enter the garage
        },
        Entrance = vector4(-1549.36, -90.79, 54.93, 356.54),
        Type = "house", -- apartment or house
        ShellType = "HighEndHouse",
    },
    {
        ...
        Price = 10000000,
        Garage = {
            Exit = vector4(-1061.75, 302.52, 65.95, 348.55), -- where the car will spawn when you take it out from your garage
            Entrance = vector3(-1061.75, 302.52, 65.95), -- where you enter the garage
        },
        Entrance = vector4(-1038.5, 312.52, 67.27, 17.97),
        Type = "house", -- apartment or house
        ShellType = "HighEndHouse",
    },
    {
        Label = "Spanish Avenue",
        Price = 10000000,
        Garage = {
            Exit = vector4(-75.89, 40.19, 71.4, 17.42), -- where the car will spawn when you take it out from your garage
            Entrance = vector3(-75.89, 40.19, 71.9), -- where you enter the garage
        },
        Entrance = vector4(-67.57, 29.34, 72.21, 330.96),
        Type = "house", -- apartment or house
        ShellType = "LowTierHouse",
    },
}
