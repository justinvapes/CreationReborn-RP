...
Citizen.CreateThread(function()
	while true do
		...
		elseif deliv == 1 and blipdestination1 then
			deliverydoor1 = true
		elseif deliv == 2 and not blipdestination2 then 
			deliverydoor2 = true
			SetDestination2()
		elseif deliv == 2 and blipdestination2 then
			deliverydoor2 = true
		elseif deliv == 3 and not blipdestination3 then
			deliverydoor3 = true
			SetDistnation3()
		elseif deliv == 3 and blipdestination3 then
			deliverydoor3 = true
		elseif deliv == 4 and not blipdestination4 then
			deliverydoor4 = true
			SetDistnation4()
		elseif deliv == 4 and blipdestination4 then
			deliverydoor4 = true
		elseif deliv == 5 and not blipdestination5 then
			deliverydoor5 = true
			SetDistnation5()
		elseif deliv == 5 and blipdestination5 then
			deliverydoor5 = true
		elseif deliv == 6 and not blipdestination6 then
			deliverydoor6 = true
			SetDistnation6()
		elseif deliv == 6 and blipdestination6 then
			deliverydoor6 = true
		elseif deliv == 7 and not blipdestination7 then
			deliverydoor7 = true
			SetDistnation7()
		elseif deliv == 7 and blipdestination7 then
			deliverydoor7 = true
		elseif deliv == 8 and not blipdestination8 then
			deliverydoor8 = true
			SetDistnation8()
		elseif deliv == 8 and blipdestination8 then
			deliverydoor8 = true
		elseif deliv == 9 and not blipdestination9 then
			deliverydoor9 = true
			SetDistnation9()
		elseif deliv == 9 and blipdestination9 then
			deliverydoor9 = true
		elseif deliv == 10 and not blipdestination10 then
			deliverydoor10 = true
			SetDistnation10()
		elseif deliv == 10 and blipdestination10 then
			deliverydoor10 = true
		elseif deliv == 11 and not blipdestination11 then
			deliverydoor11 = true
			SetDistnation11()
		elseif deliv == 11 and blipdestination11 then
			deliverydoor11 = true
		elseif deliv == 12 and not blipdestination12 then
			deliverydoor12 = true
			SetDistnation12()
		elseif deliv == 12 and blipdestination12 then
			deliverydoor12 = true
		elseif deliv == 13 and not blipdestination13 then
			deliverydoor13 = true
			SetDistnation13()
		elseif deliv == 13 and blipdestination13 then
			deliverydoor13 = true
		elseif deliv == 14 and not blipdestination14 then
			deliverydoor14 = true
			SetDistnation14()
...
function rewarduber()
	if ispedhomechance == 1 then
		...
		price = math.random(190,330)
		TriggerServerEvent('esx_uberDGFNDGFadfojsdfglkjadfgtolistdjglkadffgjm:pay', price)
		exports['mythic_notify']:SendAlert('success', 'Package Delivered with a tip! you received: $' .. price)
		removeblips()
		hasdelivery = false
		disablepressE = false
		disablepressH = false
		...
		price = math.random(175,388)
		TriggerServerEvent('esx_uberDGFNDGFadfojsdfglkjadfgtolistdjglkadffgjm:pay', price)
		exports['mythic_notify']:SendAlert('success', 'Package Delivered you received: $' .. price)
		removeblips()
		hasdelivery = false
		disablepressE = false
		disablepressH = false
					...
					if(IsControlJustPressed(1, Keys["E"])) and not deliveryporch1 and not disablepressE then
						...
						if ispedhomechance == 1 then
							...
							droppingpackage = true
							 ...
							 exports['progressBars']:startUI(wait, "Leaving Order...") 
							 Citizen.Wait(wait)
...
RegisterNetEvent('civlife_uberdelivery:start')
AddEventHandler('civlife_uberdelivery:start', function()
