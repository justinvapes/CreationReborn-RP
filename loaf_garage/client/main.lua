            ...
            if vehicles and #vehicles > 0 then
                ...
                while true do
                    ...
                    if IsDisabledControlJustReleased(0, 194) then
                        ...
                        break
                    elseif IsDisabledControlJustReleased(0, 191) and (vehicles[current_vehicle].state == 1 or vehicles[current_vehicle].state == true) and (vehicles[current_vehicle].fourrieremecano == 0 or vehicles[current_vehicle].fourrieremecano == false) and (vehicles[current_vehicle].garage_name == garage) then
                        if DoesEntityExist(vehicle) then
                            SetEntityAsMissionEntity(vehicle, true, true)
                            DeleteVehicle(vehicle)
                        end
                    ...
                    if vehicles[current_vehicle].state == 0 or vehicles[current_vehicle].state == false then
                        HelpText(string.format(Strings["browsing_vehicles"], garage, plate, Strings["impounded"]))
                    elseif vehicles[current_vehicle].fourrieremecano == 1 or vehicles[current_vehicle].fourrieremecano == true then
                        HelpText(string.format(Strings["browsing_vehicles"], garage, plate, Strings["policeimpounded"]))
                    elseif (vehicles[current_vehicle].garage_name ~= garage) then
                        HelpText(string.format(Strings["browsing_vehicles"], garage, plate, Strings["nothere"]))
                    else
