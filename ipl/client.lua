...
function RequestAllIpls()
	...
	-- Nightclub coords = -1604.664, -3012.58, -80.0
...
EnableInteriorProp(int_id , "Int01_ba_style02_podium") 
DisableInteriorProp(int_id , "Int01_ba_style03_podium") 
...
EnableInteriorProp(int_id , "DJ_01_Lights_02")--yes
...
EnableInteriorProp(int_id , "DJ_02_Lights_03")--yes
DisableInteriorProp(int_id , "DJ_02_Lights_04")

EnableInteriorProp(int_id , "DJ_03_Lights_01")--yes
...
EnableInteriorProp(int_id , "DJ_04_Lights_04")--yes
