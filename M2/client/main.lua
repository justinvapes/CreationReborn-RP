...
Citizen.CreateThread(function()
	...
	if ESX.IsPlayerLoaded() then
	  ...
	  AddTextEntry("Instructions2", Config.HelpTextMessage)
end)

RegisterNetEvent("motel2:RefreshInit")
AddEventHandler("motel2:RefreshInit", function()
	Init()
end)
...
RegisterNetEvent("motel2:eventHandler")
AddEventHandler("motel2:eventHandler", function(response, eventData)
