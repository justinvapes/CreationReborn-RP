Locales['en'] = {
  ...
  ['open_cloackroom'] = '~b~Press~w~ ~INPUT_CONTEXT~ To Go ~g~On~s~/~r~Off~s~ Duty',
  -- Armory
  ...
  ['garage_prompt'] = 'Press ~INPUT_CONTEXT~ To Access ~y~Vehicle Actions~s~',
  ...
  ['garage_storeditem'] = 'Vehicle Garage',
  ['garage_storeitem'] = 'Store Vehicle',
  ['garage_buyitem'] = 'vehicle Assignment',
  ['garage_notauthorized'] = 'you\'re not authorized to buy these kind of vehicles.',
  ['helicopter_prompt'] = 'press ~INPUT_CONTEXT~ to access the ~y~Helicopter Actions~s~.',
  ['shop_item'] = '$%s',
  ['vehicleshop_title'] = 'vehicle Shop',
  ['vehicleshop_confirm'] = 'Are You Sure You Want To Own This Vehicle?',
