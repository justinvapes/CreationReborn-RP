...
RegisterCommand('+cycleproximity', function()
	...
	if Cfg.voiceModes[voiceMode][1] ~= nil then
	showDist = true
		while showDist == true do
			Citizen.Wait(0)
			coords = GetEntityCoords(PlayerPedId(), true)
			DrawMarker(1, coords[1], coords[2], coords[3] - 0.95 ,0,0,0,0,0,0,Cfg.voiceModes[voiceMode][1]*2,Cfg.voiceModes[voiceMode][1]*2,0.1,153,0,224,200,0,true,0,0)
		end
	end
end, false)
RegisterCommand('-cycleproximity', function()
