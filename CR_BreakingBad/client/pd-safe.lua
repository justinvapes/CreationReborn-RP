...
function HandleSafeDialMovement()                
    if IsControlJustPressed( 0, 34 ) and _onSpot then
        RotateSafeDial("Anticlockwise")
        _onSpot = false
    elseif IsControlJustPressed( 0, 35 ) and _onSpot then
...
function RotateSafeDial(rotationDirection)
    ...
    if rotationDirection == "Anticlockwise" or rotationDirection == "Clockwise" then
        ...
        --     SafeDialRotation = 180
        -- elseif SafeDialRotation > 360 then
        --     SafeDialRotation = -360
        -- end
